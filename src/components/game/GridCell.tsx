...
const GridCell = ({ letter, isSelected, isInvalid = false, onClick }: GridCellProps) => {
  ...
  return (
    <div
      className={cn(
        "font-sans w-full aspect-square flex items-center justify-center rounded-xl text-xl sm:text-3xl font-bold cursor-pointer transition-all duration-150 select-none active:scale-90 touch-manipulation",
