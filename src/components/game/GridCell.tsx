...
const GridCell = ({ letter, isSelected, isInvalid = false, onClick }: GridCellProps) => {
  ...
  return (
    <div
      className={cn(
        "font-sans w-full aspect-square flex items-center justify-center rounded-xl text-2xl sm:text-4xl font-bold cursor-pointer transition-all duration-150 select-none active:scale-90 touch-manipulation",
